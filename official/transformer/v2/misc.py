...
def define_transformer_flags():
  ...
  # TF general configuration
  flags.DEFINE_string(
      name="model_version",
      default="keras",
      help=flags_core.help_wrap("Model version for test V2"))
  flags.DEFINE_string(
      name="mode",
      default="train",
      help=flags_core.help_wrap("mode: train, eval, predict"))
